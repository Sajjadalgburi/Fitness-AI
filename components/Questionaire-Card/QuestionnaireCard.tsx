...
import { useUser, useWorkoutInfo } from "@/hooks";
import { createWorkoutAction } from "@/actions/workout";
...
const QuestionnaireCard = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { saveWorkoutInfo } = useWorkoutInfo();
      saveWorkoutInfo(w);
    } catch (err) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-wrap -mx-3">
            ...
            <div className="w-full md:w-1/4 px-3 mb-6">
              <label className="block text-lg font-semibold mb-2" htmlFor="age">
                Age
              </label>
              <input
                id="age"
            ...
            <div className="w-full md:w-1/3 px-3 mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <span className=" absolute bottom-3 right-[8rem]">Pounds</span>
              </div>
            </div>
            {/* Gender */}
